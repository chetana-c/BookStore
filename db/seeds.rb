...
user1 = User.create(username:"Karan",name:"karan",email:"chetana-c@ncsu.edu",creditcardnumber:"9999999999999999",phonenumber:"1111111111",password:"1234",address:"1411 stovall dr")
